 ...
 =================
   ...
   * [Sun Netra X1](README.md#sun-netra-x1)
      * [What is this?](README.md#what-is-this)
      * [What is netbooting?](README.md#what-is-netbooting)
   * [Phase 1: The Hardware](README.md#phase-1-the-hardware)
      * [Console output](README.md#console-output)
      * [The LOM (Lights Out Management)](README.md#the-lom-lights-out-management)
      * [The Netra "BIOS" (OpenBoot)](README.md#the-netra-bios-openboot)
      * [Where should I be now?](README.md#where-should-i-be-now)
   * [Phase 2: Netbooting](README.md#phase-2-netbooting)
      * [My server](README.md#my-server)
      * [The RARP daemon](README.md#the-rarp-daemon)
      * [The TFTP Server](README.md#the-tftp-server)
         * [What is the client asking for?](README.md#what-is-the-client-asking-for)
      * [Where should I be now?](README.md#where-should-i-be-now-1)
   * [Windows 10](README.md#windows-10)
   * [Debian](README.md#debian)
      * [Installation notes](README.md#installation-notes)
   * [Solaris](README.md#solaris)
      * [The ISO](README.md#the-iso)
      * [The TFTP Server](README.md#the-tftp-server-1)
      * [Bootparams](README.md#bootparams)
      * [NFS](README.md#nfs)
      * [The Boot Process](README.md#the-boot-process)
      * [Finally Installing](README.md#finally-installing)
         * [What type of terminal are you using?](README.md#what-type-of-terminal-are-you-using)
         * [Default Route for dmfe0](README.md#default-route-for-dmfe0)
         * [Oracle registration](README.md#oracle-registration)
         * [Select Software](README.md#select-software)
      * [Installation notes](README.md#installation-notes-1)
   * [Gentoo](README.md#gentoo)
   * [OpenBSD](README.md#openbsd)
...
* Did I mention OpenCSW is awesome? Here's some quick tips:
  ...
  * Fix paths. Edit `/etc/default/login`, uncomment `PATH` and `SUPATH` and add `/opt/csw/sbin:/opt/csw/bin:` to the start. In bash, run `export MANPATH=/opt/csw/share/man:/usr/share/man` to get man pages for the new packages.
  * Install vim: `/opt/csw/bin/pkgutil -i vim -y` and whatever else you want!
  * NOTE: To be safe, some utilities that share the same name as the Solaris executable install with a 'g' prefix. Example: `gdf -h` vs `df -h`
* Oddly the `Developer System Support` software set doesn't come with any C compilers. I wanted to compare the GCC port with the native Solaris compiler so I had to find these elsewhere. GCC can be found with OpenCSW. The native Solaris compiler is part of the Sun (Oracle) Developer Studio software set, which can be [downloaded here](https://www.oracle.com/tools/developerstudio/downloads/developer-studio-jsp.html). Use the link to [Previous Releases](https://www.oracle.com/technetwork/server-storage/solarisstudio/downloads/index-jsp-142582.html) to find the version compatible with your hardware.
  ...
  * NOTE: Developer studio 12.5 also isn't compatible with UltraSPARC IIe, although it will install regardless. Luckily it doesn't seem to break the system; it just won't run. In my case, `cc` gave the error "invalid argument" to every command. Running `file $(which cc)` showed that it was an UltraSPARC III executable, which clearly isn't going to work.
  * To set up paths for Sun (Oracle) Developer Studio 12.4, edit `/etc/default/login` and add `/opt/solarisstudio12.4/bin:` to the start of both `PATH` and `SUPATH`, and run `export MANPATH=/opt/solarisstudio12.4/share/man:/opt/csw/share/man:/usr/share/man` to get man pages for the new packages.
